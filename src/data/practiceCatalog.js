...
function buildMockFullTestCard(card, baseUrl = '') {
  ...
  return {
    ...
    sourceId: card.id,
    title: sourceLabel,
    summary: 'Thi thử full test 200 câu với đủ 7 phần TOEIC.',
...
function getPartPracticeCatalog(baseUrl = '') {
  ...
  return {
    ...
    heroDescription: 'Chọn đúng Part cần ôn và bắt đầu luyện tập ngay.',
...
function getReadingPracticeCatalog(baseUrl = '') {
  ...
  return {
    ...
    heroDescription: 'Gom sẵn Part 5, 6, 7 để bạn luyện Reading trọn phiên 75 phút.',
...
function getMockFullTestCatalog(baseUrl = '') {
  ...
  return {
    ...
    heroDescription: 'Chọn đề và vào thi thử full test ngay.',
...
function buildMockFullTestExam(testId, baseUrl = '') {
  ...
  return {
    ...
    description: 'Bài thi gồm đủ 200 câu và 7 phần TOEIC.',
    sourceLabel,
    badgeLabel: sourceExam.collectionLabel || sourceExam.bookName || '',
    accessLabel: 'Free',
